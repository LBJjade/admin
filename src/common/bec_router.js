...
export const getRouterData = (app) => {
  const routerConfig = {
    ...
    '/goods/category': {
      component: dynamicWrapper(app, ['category'], () => import('../routes/Goods/Category')),
    },
    '/goods/spec': {
    ...
    '/goods/goods': {
      component: dynamicWrapper(app, ['goods', 'file'], () => import('../routes/Goods/Goods')),
    },
    '/goods/goods/:objectId': {
      component: dynamicWrapper(app, ['goods', 'file'], () => import('../routes/Goods/Goods')),
    },
  };
